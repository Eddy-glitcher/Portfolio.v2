        ...
        <section className='home' id='home'>
            <div className="home__center">
                ...
                <div className="home__btns">
                    <Anchor href='#projects' variant='primary'>Proyectos</Anchor>
                    <Anchor href='#contact' variant='secondary'>Conectemos</Anchor>
                </div>
            
                <div className="home__social">
                    <div className='home__social-item home__social-item--github'>
                        <Anchor variant='social' href='https://github.com/Eddy-glitcher' target='_blank'>
                    ...
                    <div className='home__social-item home__social-item--linkedin'>
                        <Anchor href='https://www.linkedin.com/in/luis-edier-aguirre/' target='_blank' variant='social'>
                    ...
                    <div className='home__social-item home__social-item--message'>
                        <Anchor variant='social' href='mailto:luis-gonzales6@hotmail.com'>
